...
public class TestCompletedEventWarnings
{
            ...
            throws Exception
    {
        ...
        generatedEvents = new TestEventListener.EventsBuilder();
        queryRunner = DistributedQueryRunner.builder(sessionBuilder.build())
                ...
                .setNodeCount(1)
                .build();
        queryRunner.installPlugin(new TestEventListenerPlugin.TestingEventListenerPlugin(generatedEvents));
            ...
            throws InterruptedException
    {
        assertWarnings(
                "select 1",
                ImmutableMap.of(),
                new TestingWarningCollector(new WarningCollectorConfig(), new TestingWarningCollectorConfig().setTestWarnings(TEST_WARNINGS)).getWarnings().stream()
