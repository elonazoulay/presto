...
import com.facebook.presto.plugin.turbonium.MemoryConfig;
...
public class MemoryConfigMapper
    implements ResultSetMapper<MemoryConfig>
{
    @Override
    public MemoryConfig map(int index, ResultSet resultSet, StatementContext context)
            throws SQLException
    {
