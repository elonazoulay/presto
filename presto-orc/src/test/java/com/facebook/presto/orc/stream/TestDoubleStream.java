        ...
        extends AbstractTestValueStream<Double, DoubleStreamCheckpoint, DoubleOutputStream, DoubleInputStream>
{
            ...
            throws OrcCorruptionException
    {
        ...
        return new DoubleInputStream(new OrcInputStreamV1(ORC_DATA_SOURCE_ID, slice.getInput(), orcDecompressor, newSimpleAggregatedMemoryContext(), slice.getRetainedSize()));
    }
