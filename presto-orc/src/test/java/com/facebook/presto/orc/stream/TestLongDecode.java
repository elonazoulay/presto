...
public class TestLongDecode
{
            ...
            throws IOException
    {
        ...
        long readValueNew = readVInt(signed, new OrcInputStreamV1(new OrcDataSourceId("test"), hiveBytes.getInput(), Optional.empty(), newSimpleAggregatedMemoryContext(), hiveBytes.getRetainedSize()));
