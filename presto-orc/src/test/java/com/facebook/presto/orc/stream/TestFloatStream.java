        ...
        extends AbstractTestValueStream<Float, FloatStreamCheckpoint, FloatOutputStream, FloatInputStream>
{
            ...
            throws OrcCorruptionException
    {
        ...
        return new FloatInputStream(new OrcInputStreamV1(ORC_DATA_SOURCE_ID, slice.getInput(), orcDecompressor, newSimpleAggregatedMemoryContext(), slice.getRetainedSize()));
    }
