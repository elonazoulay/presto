...
public class TestDecimalStream
{
    ...
    {
        return new OrcInputStreamV1(new OrcDataSourceId(source), new BasicSliceInput(Slices.wrappedBuffer(bytes)), Optional.empty(), newSimpleAggregatedMemoryContext(), bytes.length);
    }
