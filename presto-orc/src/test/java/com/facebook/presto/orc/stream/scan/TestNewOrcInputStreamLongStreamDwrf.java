...
public class TestNewOrcInputStreamLongStreamDwrf
        extends AbstractTestLongStream
{
    ...
    protected LongInputStream createValueStream(Slice slice, CompressionKind kind) throws OrcCorruptionException
    {
        ...
        OrcInputStream input = new OrcInputStreamV2(ORC_DATA_SOURCE_ID, slice.getInput(), orcDecompressor, newSimpleAggregatedMemoryContext(), slice.getRetainedSize());
