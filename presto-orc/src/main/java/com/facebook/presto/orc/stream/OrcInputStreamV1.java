...
import com.facebook.presto.orc.stream.scan.Buffer;
...
public final class OrcInputStreamV1
        extends OrcInputStream
{
            ...
            long sliceInputRetainedSizeInBytes)
    {
        ...
        this.bufferMemoryUsage = systemMemoryContext.newLocalMemoryContext(OrcInputStreamV1.class.getSimpleName());
        checkArgument(sliceInputRetainedSizeInBytes >= 0, "sliceInputRetainedSizeInBytes is negative");
        systemMemoryContext.newLocalMemoryContext(OrcInputStreamV1.class.getSimpleName()).setBytes(sliceInputRetainedSizeInBytes);
