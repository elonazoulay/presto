...
public final class OrcInputStreamV2
        extends OrcInputStream
{
            ...
            long sliceInputRetainedSizeInBytes)
    {
        ...
        this.bufferMemoryUsage = systemMemoryContext.newLocalMemoryContext(OrcInputStreamV2.class.getSimpleName());
        checkArgument(sliceInputRetainedSizeInBytes >= 0, "sliceInputRetainedSizeInBytes is negative");
        systemMemoryContext.newLocalMemoryContext(OrcInputStreamV2.class.getSimpleName()).setBytes(sliceInputRetainedSizeInBytes);
