...
public class TestResourceGroupsDao
{
    ...
    private static void testResourceGroupInsert(H2ResourceGroupsDao dao, Map<Long, ResourceGroupSpecBuilder> map)
    {
        ...
        dao.insertResourceGroup(2, "bi", "50%", "100%", 50, 50, null, null, null, null, null, null, null, 1L);
        List<ResourceGroupSpecBuilder> records = dao.getResourceGroups();
        assertEquals(records.size(), 2);
        map.put(1L, new ResourceGroupSpecBuilder(1, new ResourceGroupNameTemplate("global"), "100%", "100%", 100, 100, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), null));
        map.put(2L, new ResourceGroupSpecBuilder(2, new ResourceGroupNameTemplate("bi"), "50%", "100%", 50, 50, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(1L)));
    ...
    {
        dao.updateResourceGroup(2, "bi", "40%", "100%", 40, 30, null, null, true, null, null, null, null, 1L);
        ResourceGroupSpecBuilder updated = new ResourceGroupSpecBuilder(2, new ResourceGroupNameTemplate("bi"), "40%", "100%", 40, 30, Optional.empty(), Optional.empty(), Optional.of(true), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(1L));
        map.put(2L, updated);
    ...
    private static void testSelectorInsert(H2ResourceGroupsDao dao, Map<Long, SelectorRecord> map)
    {
        ...
        dao.insertResourceGroup(2, "ping_query", "50%", "100%", 50, 50, null, null, null, null, null, null, null, 1L);
        dao.insertResourceGroup(3, "config", "50%", "100%", 50, 50, null, null, null, null, null, null, null, 1L);
