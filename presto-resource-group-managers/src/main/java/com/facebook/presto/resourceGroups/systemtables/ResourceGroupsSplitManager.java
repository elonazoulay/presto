    ...
    implements ConnectorSplitManager
{
    ...
    {
        ResourceGroupsTableLayoutHandle layout = checkType(
                layoutHandle,
                ResourceGroupsTableLayoutHandle.class,
                "ResourceGroupsTableLayoutHandle");

        ImmutableList.Builder<ResourceGroupsSplit> builder = ImmutableList.builder();
