...
public class AddSelectorProcedure
{
    private final ConfigurationNotifier configurationNotifier;

    @Inject
    public AddSelectorProcedure(ConfigurationNotifier configurationNotifier)
    {
    ...
    public Procedure getProcedure()
    {
        return new Procedure(
            ...
            methodHandle(ConfigurationNotifier.class, "addSelector",
                    String.class,
                    String.class,
