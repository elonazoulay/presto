...
public class AlterResourceGroupProcedure
{
    private final ConfigurationNotifier configurationNotifier;

    @Inject
    public AlterResourceGroupProcedure(ConfigurationNotifier configurationNotifier)
    {
    ...
    public Procedure getProcedure()
    {
        return new Procedure(
            ...
            ImmutableList.of(
                    ...
                    new Argument("maxMemoryPerQuery", VARCHAR),
            ...
            methodHandle(ConfigurationNotifier.class, "alterResourceGroup",
                    String.class,
                    String.class,
                    String.class,
                    String.class,
