        ...
        implements StatementRewrite.Rewrite
{
            ...
            extends AstVisitor<Node, Void>
    {
                ...
                throws SemanticException
        {
            ...
            return getQueryPlan(node, planType, planFormat, warningCollector);
        }

        private Node getQueryPlan(Explain node, ExplainType.Type planType, ExplainFormat.Type planFormat, WarningCollector warningCollector)
