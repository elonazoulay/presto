...
public class TestDefaultWarningCollector
{
    ...
    @Test
    public void testDistinctWarnings()
    {
        WarningCollector warningCollector = new DefaultWarningCollector(new WarningCollectorConfig().setMaxDistinctWarningCodes(2).setMaxWarningsPerWarningCode(2));
        warningCollector.add(new PrestoWarning(new WarningCode(1, "1"), "warning 1"));
